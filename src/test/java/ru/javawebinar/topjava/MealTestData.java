...
public class MealTestData {
    ...
    public static final Meal MEAL_7 = new Meal(100008, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Админ_Завтрак", 900);
    public static final Meal MEAL_8 = new Meal(100009, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Админ_Ужин", 400);
